class SurveyQuestionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @survey_question.save
        format.html { redirect_to @survey_question.survey, notice: 'Survey question was successfully created.' }
        format.json { render :show, status: :created, location: @survey_question.survey }
      else
  ...
  def add_question
    # adds a survey question to the given survey
    @survey_question = SurveyQuestion.new
    respond_to do |format|
      format.html
      format.js
  ...
  private
    ...
    def survey_question_params
      params.require(:survey_question).permit(:survey_id, :survey_question_type_id, :question)
    end
end
